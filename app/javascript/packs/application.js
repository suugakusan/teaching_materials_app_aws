...
$(function() {
  $('#school_type').change(function() {
    ...
    if ( text == "小学校" ){
      ...
      $('#school_grade').fadeIn();
      $('#post_grade').append($('<option>').html("学年").val("学年"));
      ...
      $('#post_subject_id').append($('<option>').html("教科").val("教科"));
...
$(function() {
  $(document).on('change', '#subject_select', function() {
    ...
    if ( subjecttext == "国語"){
      ...
      $('#subjectbook').fadeIn();
      $('#post_schoolbook').append($('<option>').html("教科書").val("教科書"));
